...
import { FaLandmark, FaLevelUpAlt, FaSpa, FaSwimmingPool } from "react-icons/fa";
...
export const amenities = [
  ...
  },
  {
    id: 2,
    title: "Balcony",
    icon: React.createElement(MdBalcony),
  },
  {
    id: 3,
    title: "Private Pool",
    icon: React.createElement(FaSwimmingPool),
  },
  {
    id: 4,
    title: "Shared Spa",
  ...
  },
  {
    ...
    icon:  React.createElement(LuParkingMeter),
  },
  {
    id: 6,
    title: "Central A/C",
    icon: React.createElement(TbAirConditioning),
  },
  {
    id: 7,
    title: "Private Garden",
    icon: React.createElement(FaLevelUpAlt),
  },
  {
    id: 8,
    title: "Security",
    icon: React.createElement(PiSecurityCamera),
  },
  {
    id: 9,
    title: "Built in Wardrobes",
    icon: React.createElement(TbHanger),
  },
  {
    id: 10,
    title: "Kitchen Appliances",
    icon: React.createElement(TbToolsKitchen3),
  },
  {
    id: 11,
